...
describe(`${PATHNAME_TEMPLATE} getPathname`, () => {
  describe('if `propertyId` is not defined', () => {
    it('should return the right string', () => {
      ...
      expect(actual).toBe('/v2/websites/availability/website/321');
    });
  });
  ...
  describe('if `roomTypeId` is not defined', () => {
    it('should return the right string', () => {
      ...
      expect(actual).toBe('/v2/websites/availability/website/321/property/123');
    });
  });
  ...
  describe('by default', () => {
    it('should return the right string', () => {
      ...
      expect(actual).toBe(
        '/v2/websites/availability/website/321/property/123/roomtype/987'
      );
    });
  });
});
